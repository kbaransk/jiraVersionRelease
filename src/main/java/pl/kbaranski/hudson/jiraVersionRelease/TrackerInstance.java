...
/**
 * This class describes single instance of JIRA issue tracker.
 * It's quite probable that single instance of JIRA will contains projects connected with mamy different Jenkins / Hudson jobs so it's good idea to setup this data only once.
 * @author Krzysztof Barański
 * @since 1.1
 */
public class TrackerInstance {

	/** Name of JIRA instance. This values will be presented in select box on job setup page. */
